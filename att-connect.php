...
<html>
    ...
    <body>
        ...
        <div class="sections">
            ...
            $search = "SELECT Name FROM attractions WHERE ID='$id'";
            ...
            $query = "SELECT * FROM att WHERE user_id='$user_id' AND event_id='$id' AND comment IS NULL";
            $sql0 = mysqli_query($db, $query);
            if(mysqli_num_rows($sql0)==0){
                $insert = "INSERT INTO att (event_id, user_id) VALUES ('$id', '$user_id')";
                $sql = mysqli_query($db, $insert);
            }
        
            $query1 = "SELECT * FROM att WHERE event_id='$id' AND comment IS NULL";
