    ...
    <body>
        ...
        <div>
            ...
            <div class="button" style="margin-right: 32%; margin-top: 10px;">
                    <?php echo "<td><a href=\"events-connect.php?ID=" . $id . "\">Connect!</a></td>"; ?>
        ...
        <div class="texter">
            ...
            <p style="float: right; margin-right: 30px"> Hours: <?php echo $row['Hours']; ?></p>
        </div>
            <br>
            <br>
        <div class="texter">
        ...
        <div class="texter">
            <table>
                ...
                <?php
                    $query="SELECT * FROM evnt WHERE event_id='$id' AND comment IS NOT NULL";
        ...
        <?php 
            if(isset($_POST['Submit'])){
                ...
                $query= "INSERT INTO evnt (comment, event_id, user_id) VALUES('$comment','$id','$user_id')";
