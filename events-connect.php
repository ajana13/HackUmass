...
<html>
    ...
    <body>
        ...
        <div class="sections">
            ...
            $search = "SELECT Name FROM events WHERE ID='$id'";
            ...
            $query = "SELECT * FROM evnt WHERE user_id='$user_id' AND event_id='$id' AND comment IS NULL";
            $sql0 = mysqli_query($db, $query);
            if(mysqli_num_rows($sql0)==0){
                $insert = "INSERT INTO evnt (event_id, user_id) VALUES ('$id', '$user_id')";
                $sql = mysqli_query($db, $insert);
            }
        
            $query1 = "SELECT * FROM evnt WHERE event_id='$id' AND comment IS NULL";
            ...
            while($result = mysqli_fetch_assoc($sql1)){
                ...
                <?php
                    ...
                    <br>
                    <br>
                    <input type="button" name="view" class="butt friend" value="Add" id="<?php echo $result1["id"]; ?>">
                </div>
                <br>
                <?php
                }
